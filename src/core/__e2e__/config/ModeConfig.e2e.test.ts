...
suite("CustomModeSchema", () => {
	suite("validateCustomMode", () => {
	...
	suite("fileRegex", () => {
		test("validates a mode with file restrictions and descriptions", () => {
		...
		test("validates file regex patterns", () => {
		...
		test("prevents duplicate groups", () => {
