...
suite("read_file tool with maxReadFileLine setting", () => {
	...
	const originalCountFileLines = // TODO: requireActual<typeof import("../../integrations/misc/line-counter")>(
		"../../integrations/misc/line-counter",
	).countFileLines
	const originalReadLines = // TODO: requireActual<typeof import("../../integrations/misc/read-lines")>(
		"../../integrations/misc/read-lines",
	).readLines
	const originalExtractTextFromFile = // TODO: requireActual<typeof import("../../integrations/misc/extract-text")>(
		"../../integrations/misc/extract-text",
	).extractTextFromFile
	const originalAddLineNumbers = // TODO: requireActual<typeof import("../../integrations/misc/extract-text")>(
		"../../integrations/misc/extract-text",
	).addLineNumbers
