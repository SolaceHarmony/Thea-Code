...
suite("getModelParams", () => {
	test("should return default values when no custom values are provided", () => {
		const options = {}
		const model = {
			id: "test-model",
			contextWindow: 16000,
	...
	test("should use custom temperature from options when provided", () => {
	...
	test("should use model maxTokens when available", () => {
		const options = {}
		const model = {
			id: "test-model",
			maxTokens: 2000,
	...
	test("should handle thinking models correctly", () => {
		const options = {}
		const model = {
			id: "test-model",
			thinking: true,
	...
	test("should honor customMaxTokens for thinking models", () => {
	...
	test("should honor customMaxThinkingTokens for thinking models", () => {
	...
	test("should not honor customMaxThinkingTokens for non-thinking models", () => {
		const options = { modelMaxThinkingTokens: 1500 }
		const model = {
			id: "test-model",
			maxTokens: 4000,
	...
	test("should clamp thinking budget to at least 1024 tokens", () => {
	...
	test("should clamp thinking budget to at most 80% of max tokens", () => {
	...
	test("should use ANTHROPIC_DEFAULT_MAX_TOKENS when no maxTokens is provided for thinking models", () => {
		const options = {}
		const model = {
			id: "test-model",
			thinking: true,
