...
suite("Vertex Provider Edge Cases", () => {
	...
	let mockClient: sinon.SinonStubbedInstance<NeutralVertexClient>
	...
	suite("Claude path", () => {
		...
		test("should handle Claude thinking variants", async () => {
			...
			assert.notStrictEqual(reasoningChunk, undefined)
	...
	suite("Configuration handling", () => {
		...
		test("should accept valid regions", () => {
			...
			validRegions.forEach(region => {
				...
				assert.notStrictEqual(h, undefined)
			})
		})
		...
		test("should handle authentication options", () => {
			...
			assert.notStrictEqual(withKey, undefined)
			...
			assert.notStrictEqual(withDefault, undefined)
		})
	})
