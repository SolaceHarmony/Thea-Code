...
export default [
	...
	globalIgnores([
		...
		// SCRIPTS NOT IN TSCONFIG: Utility scripts (setup-helpers, build scripts, etc)
		// These are run with Node directly, not TypeScript, so use espree not TS parser
		"scripts/**/*.ts",
		"scripts/**/*.js",
		"scripts/**/*.js.map",
		
		// FILES NOT IN ANY TSCONFIG: These don't have type checking context
		"thea-code/**",  // Autogenerated module definitions
		"esbuild.mjs",    // Build config
		"webview-ui/.storybook/**",  // Storybook config not in webview tsconfig
