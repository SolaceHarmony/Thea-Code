...
suite("TheaStateManager", () => {
	...
	let mockCustomModesManager: sinon.SinonStubbedInstance<CustomModesManager>
	...
	setup(() => {
		...
		;(ContextProxy as any) = sinon.stub().callsFake(() => mockContextProxy)

		// Mock provider settings manager
		mockProviderSettingsManager = {} as sinon.SinonStubbedInstance<ProviderSettingsManager>
		...
		} as unknown as sinon.SinonStubbedInstance<CustomModesManager>
